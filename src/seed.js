  ...
  const dinosaurs = [
    {
      ...
      image: `${baseUrl}/api/dinosaur/image/1.png`,
      diet: 2,
      size: '39 ft (12 m)',
      locations: [1, 2],
      period: 3,
    ...
    },
    {
      ...
      image: `${baseUrl}/api/dinosaur/image/2.png`,
      diet: 1,
      size: '30 ft (9 m)',
      locations: [1, 2],
      period: 3,
    ...
    },
    {
      ...
      image: `${baseUrl}/api/dinosaur/image/3.png`,
      diet: 1,
      size: '30 ft (9 m)',
      locations: [1, 3],
      period: 2,
    ...
    },
    {
      ...
      image: `${baseUrl}/api/dinosaur/image/4.png`,
      diet: 1,
      size: '20 ft (6 m)',
      locations: [1, 2],
      period: 3,
    ...
    },
    {
      ...
      image: `${baseUrl}/api/dinosaur/image/5.png`,
      diet: 1,
      size: '75 ft (23 m)',
      locations: [1],
      period: 2,
    ...
    },
    {
      ...
      image: `${baseUrl}/api/dinosaur/image/6.png`,
      diet: 2,
      size: '61⁄2 ft (2 m)',
      locations: [4],
      period: 3,
    ...
    },
    {
      ...
      image: `${baseUrl}/api/dinosaur/image/7.png`,
      diet: 2,
      size: '30 ft (9 m)',
      locations: [3, 5, 6],
      period: 3,
    ...
    },
    {
      ...
      image: `${baseUrl}/api/dinosaur/image/8.png`,
      diet: 2,
      size: '30 ft (9 m)',
      locations: [7],
      period: 3,
    ...
    },
    {
      ...
      image: `${baseUrl}/api/dinosaur/image/9.png`,
      diet: 1,
      size: '15 ft (4.5 m)',
      locations: [1, 2],
      period: 3,
    ...
    },
    {
      ...
      image: `${baseUrl}/api/dinosaur/image/10.png`,
      diet: 1,
      size: '30 ft (9 m)',
      locations: [1, 2],
      period: 3,
    ...
    },
    {
      ...
      image: `${baseUrl}/api/dinosaur/image/11.png`,
      diet: 1,
      size: '43 ft (13 m)',
      locations: [1, 2],
      period: 3,
    ...
    },
    {
      ...
      image: `${baseUrl}/api/dinosaur/image/12.png`,
      diet: 3,
      size: '20 ft (6 m)',
      locations: [4],
      period: 3,
