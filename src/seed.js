  ...
  const taxonomies = [
    {
      ...
      url: 'https://dinosaurapi.herokuapp.com/api/taxonomy/1',
    },
    {
      id: 2,
      name: 'Saurischia',
      ...
      parent: 1,
      url: 'https://dinosaurapi.herokuapp.com/api/taxonomy/2',
    },
    {
      id: 3,
      name: 'Ornithischia',
      ...
      parent: 1,
      url: 'https://dinosaurapi.herokuapp.com/api/taxonomy/3',
    },
    {
      id: 4,
      ...
      parent: 2,
      url: 'https://dinosaurapi.herokuapp.com/api/taxonomy/4',
    },
    {
      id: 5,
      name: 'Theropoda',
      ...
      parent: 2,
      url: 'https://dinosaurapi.herokuapp.com/api/taxonomy/5',
    },
    {
      id: 6,
      ...
      parent: 3,
      url: 'https://dinosaurapi.herokuapp.com/api/taxonomy/6',
    },
    {
      id: 7,
      name: 'Ornithopoda',
      ...
      parent: 3,
      url: 'https://dinosaurapi.herokuapp.com/api/taxonomy/7',
    },
    {
      id: 8,
      name: 'Thyreophora',
      ...
      parent: 3,
      url: 'https://dinosaurapi.herokuapp.com/api/taxonomy/8',
    },
    {
      id: 9,
      name: 'Ceratopsia',
      ...
      parent: 6,
      url: 'https://dinosaurapi.herokuapp.com/api/taxonomy/9',
    },
    {
      id: 10,
      ...
      parent: 6,
      url: 'https://dinosaurapi.herokuapp.com/api/taxonomy/10',
    },
    {
      id: 11,
      name: 'Stegosauria',
      ...
      parent: 8,
      url: 'https://dinosaurapi.herokuapp.com/api/taxonomy/11',
    },
    {
      id: 12,
      name: 'Ankylosauria',
      ...
      parent: 8,
      url: 'https://dinosaurapi.herokuapp.com/api/taxonomy/12',
    },
  ];
  ...
  await models.period.create([
    {
      ...
      from: 251,
      to: 200,
      url: 'https://dinosaurapi.herokuapp.com/api/period/1',
    },
    {
      id: 2,
      name: 'Jurassic',
      ...
      from: 200,
      to: 145,
      url: 'https://dinosaurapi.herokuapp.com/api/period/2',
    },
    {
      id: 3,
      name: 'Cretaceous',
      ...
      from: 145,
      to: 66,
      url: 'https://dinosaurapi.herokuapp.com/api/period/3',
    },
  ]);
}
  ...
  await models.diet.create([
    {
      ...
      url: 'https://dinosaurapi.herokuapp.com/api/diet/1',
    },
    {
      id: 2,
      name: 'Carnivore',
      description: 'An animal that eats meat.',
      url: 'https://dinosaurapi.herokuapp.com/api/diet/2',
    },
    {
      id: 3,
      name: 'Omnivore',
      ...
      url: 'https://dinosaurapi.herokuapp.com/api/diet/3',
    },
    {
      id: 4,
      name: 'Unknow',
      description: 'Unknow diet',
      url: 'https://dinosaurapi.herokuapp.com/api/diet/4',
    },
  ]);
}
  ...
  await models.location.create([
    {
      id: 1,
      name: 'United States',
      // "image": "https://dinosaurapi.herokuapp.com/api/location/image/1.jpg",
      url: 'https://dinosaurapi.herokuapp.com/api/location/1',
    },
    {
      id: 2,
      name: 'Canada',
      // "image": "https://dinosaurapi.herokuapp.com/api/location/image/2.jpg",
      url: 'https://dinosaurapi.herokuapp.com/api/location/2',
    },
    {
      id: 3,
      name: 'Portugal',
      // "image": "https://dinosaurapi.herokuapp.com/api/location/image/3.jpg",
      url: 'https://dinosaurapi.herokuapp.com/api/location/3',
    },
    {
      id: 4,
      name: 'Mongolia',
      // "image": "https://dinosaurapi.herokuapp.com/api/location/image/4.jpg",
      url: 'https://dinosaurapi.herokuapp.com/api/location/4',
    },
    {
      id: 5,
      name: 'British Isles',
      // "image": "https://dinosaurapi.herokuapp.com/api/location/image/5.jpg",
      url: 'https://dinosaurapi.herokuapp.com/api/location/5',
    },
    {
      id: 6,
      name: 'Spain',
      // "image": "https://dinosaurapi.herokuapp.com/api/location/image/6.jpg",
      url: 'https://dinosaurapi.herokuapp.com/api/location/6',
    },
    {
      id: 7,
      name: 'Africa',
      // "image": "https://dinosaurapi.herokuapp.com/api/location/image/7.jpg",
      url: 'https://dinosaurapi.herokuapp.com/api/location/7',
    },
  ]);
}
  ...
  const dinosaurs = [
    {
      ...
      image: 'https://dinosaurapi.herokuapp.com/api/dinosaur/image/1.png',
      diet: 2,
      size: '39 ft (12 m)',
      locations: [1, 2],
      period: 3,
      taxonomies: [1, 2, 5],
      url: 'https://dinosaurapi.herokuapp.com/api/dinosaur/1',
    },
    {
      id: 2,
      name: 'Triceratops',
      ...
      image: 'https://dinosaurapi.herokuapp.com/api/dinosaur/image/2.png',
      diet: 1,
      size: '30 ft (9 m)',
      locations: [1, 2],
      period: 3,
      taxonomies: [1, 3, 6, 9],
      url: 'https://dinosaurapi.herokuapp.com/api/dinosaur/2',
    },
    {
      id: 3,
      name: 'Stegosaurus',
      ...
      image: 'https://dinosaurapi.herokuapp.com/api/dinosaur/image/3.png',
      diet: 1,
      size: '30 ft (9 m)',
      locations: [1, 3],
      period: 2,
      taxonomies: [1, 3, 8, 11],
      url: 'https://dinosaurapi.herokuapp.com/api/dinosaur/3',
    },
    {
      id: 4,
      name: 'Ankylosaurus',
      ...
      image: 'https://dinosaurapi.herokuapp.com/api/dinosaur/image/4.png',
      diet: 1,
      size: '20 ft (6 m)',
      locations: [1, 2],
      period: 3,
      taxonomies: [1, 3, 8, 12],
      url: 'https://dinosaurapi.herokuapp.com/api/dinosaur/4',
    },
    {
      id: 5,
      name: 'Brachiosaurus',
      ...
      image: 'https://dinosaurapi.herokuapp.com/api/dinosaur/image/5.png',
      diet: 1,
      size: '75 ft (23 m)',
      locations: [1],
      period: 2,
      taxonomies: [1, 2, 4],
      url: 'https://dinosaurapi.herokuapp.com/api/dinosaur/5',
    },
    {
      id: 6,
      name: 'Velociraptor',
      ...
      image: 'https://dinosaurapi.herokuapp.com/api/dinosaur/image/6.png',
      diet: 2,
      size: '61⁄2 ft (2 m)',
      locations: [4],
      period: 3,
      taxonomies: [1, 2, 5],
      url: 'https://dinosaurapi.herokuapp.com/api/dinosaur/6',
    },
    {
      id: 7,
      name: 'Baryonyx',
      ...
      image: 'https://dinosaurapi.herokuapp.com/api/dinosaur/image/7.png',
      diet: 2,
      size: '30 ft (9 m)',
      locations: [3, 5, 6],
      period: 3,
      taxonomies: [1, 2, 5],
      url: 'https://dinosaurapi.herokuapp.com/api/dinosaur/7',
    },
    {
      id: 8,
      name: 'Suchomimus',
      ...
      image: 'https://dinosaurapi.herokuapp.com/api/dinosaur/image/8.png',
      diet: 2,
      size: '30 ft (9 m)',
      locations: [7],
      period: 3,
      taxonomies: [1, 2, 5],
      url: 'https://dinosaurapi.herokuapp.com/api/dinosaur/8',
    },
    {
      id: 9,
      ...
      image: 'https://dinosaurapi.herokuapp.com/api/dinosaur/image/9.png',
      diet: 1,
      size: '15 ft (4.5 m)',
      locations: [1, 2],
      period: 3,
      taxonomies: [1, 3, 6, 10],
      url: 'https://dinosaurapi.herokuapp.com/api/dinosaur/9',
    },
    {
      id: 10,
      ...
      image: 'https://dinosaurapi.herokuapp.com/api/dinosaur/image/10.png',
      diet: 1,
      size: '30 ft (9 m)',
      locations: [1, 2],
      period: 3,
      taxonomies: [1, 3, 7],
      url: 'https://dinosaurapi.herokuapp.com/api/dinosaur/10',
    },
    {
      id: 11,
      name: 'Edmontosaurus',
      ...
      image: 'https://dinosaurapi.herokuapp.com/api/dinosaur/image/11.png',
      diet: 1,
      size: '43 ft (13 m)',
      locations: [1, 2],
      period: 3,
      taxonomies: [1, 3, 7],
      url: 'https://dinosaurapi.herokuapp.com/api/dinosaur/11',
    },
    {
      id: 12,
      name: 'Gallimimus',
      ...
      image: 'https://dinosaurapi.herokuapp.com/api/dinosaur/image/12.png',
      diet: 3,
      size: '20 ft (6 m)',
      locations: [4],
      period: 3,
      taxonomies: [1, 2, 5],
      url: 'https://dinosaurapi.herokuapp.com/api/dinosaur/12',
    },
  ];
